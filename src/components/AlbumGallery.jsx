    ...
    return (
      <>
        <nav className="navbar">
          <div className="brand-name">Album Vault</div>
          <div className="nav-social-links">
            <a href="https://x.com/goelsahhab" target="_blank" rel="noopener noreferrer" className="nav-social-icon" aria-label="X/Twitter">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="https://github.com/goelsahhab/album-party" target="_blank" rel="noopener noreferrer" className="nav-social-icon" aria-label="GitHub">
              <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
        ...
        <div className="landing-container">
          ...
          <div className="landing-content">
            ...
            <h1 className="main-heading">
              Flex Your <span className="highlight">Playlist</span>
            </h1>
            <p className="subheading">
              Transform your Spotify albums into stunning visual art
            </p>
            ...
            <div className="features-section">
              ...
              <div className="feature-card">
                <div className="feature-icon icon-styles"></div>
                <h3 className="feature-title">Multiple Styles</h3>
                <p className="feature-description">
                  Choose from Grid, Collage, Polaroid, and Magazine layouts
                </p>
              </div>
            </div>
        ...
        <footer className="landing-footer">
          <p className="footer-text">
            built by <a href="https://x.com/goelsahhab" target="_blank" rel="noopener noreferrer" className="footer-link">@goelsahhab</a> · thanks to spotify
          </p>
        </footer>
      </>
    )
